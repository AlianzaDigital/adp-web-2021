...
$params = array(
    ...
    'origen' => ($getURL),
    'comentarios' => ("Landing Web Fixed Nuevo Lead")." | ".("Tipo de casa: ".$tipo_casa_fixed_web)." | ".("Tiempo de inversion: ".$inversion_fixed_web)." | ".("Medio para contactar: ".$checkbox_seleccionados)." | ".("Call UTM: ".$actualURL)
);
...
$Subject = "Landing Web Fixed Nuevo Lead";
...
$Body .= utf8_decode($getURL);
$Body .= "\n";

$Body .= utf8_decode("Call UTM: ");
$Body .= utf8_decode($actualURL);
$Body .= "\n";
